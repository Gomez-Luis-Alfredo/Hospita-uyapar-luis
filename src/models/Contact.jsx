    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
        <div className="popup-form absolute mt-12 text-black">
            <form className="w-80 md:w-96 space-y-5 bg-white p-5 rounded-xl">
                ...
                <div className="flex flex-col">
                    <input type="email" name="userEmail" id="serEmail" placeholder="Your Email"
                    className="py-3 px-2 bg-[#d5f2ec] rounded-lg"
                    />
                </div>
                <div className="flex flex-col">
                    <input type="number" name="userNumber" id="userNumber" placeholder="Phone No."
                    className="py-3 px-2 bg-[#d5f2ec] rounded-lg"
                    />
                </div>
                <div className="flex gap-5">
                    <Button title='Book Appointment'/>
                    <button className="bg-backgroundColor text-whiter px-10 rounded-md active:bg-red-500" onClick={closeForm}>Close</button>
                </div>
            </form>
        </div>
    </div>
